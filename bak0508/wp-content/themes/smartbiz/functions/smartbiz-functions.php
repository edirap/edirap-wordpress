	...
	if (!class_exists('SmartBiz')) {
		...
		$this->paths = wp_upload_dir(true);
			...
			$this->options = array(
				...
				array(	"name" => __('Logo image file name: e.g. logo.png', 'smartbiz'),
								"id" => $this->shortname."_logo_image_url",
								"desc" => __('Upload your logo image here: ', 'smartbiz') .'<code>' . $this->paths['baseurl'] . '/images/logo/</code>',
								"std" => '',
								"type" => "text"),
				...
				array(	"name" => __('Featured image file name: e.g. featured.png', 'smartbiz'),
								"id" => $this->shortname."_featured_image_url",
								"desc" => __('Upload your image here: ', 'smartbiz') .'<code>' . $this->paths['baseurl'] . '/images/featured/</code>',
								"std" => '',
								"type" => "text"),
