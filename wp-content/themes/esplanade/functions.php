...
function my_add_frontend_scripts() {
    if( ! is_admin() ) {
		...
		wp_register_script( 'jquery-megamenu', get_template_directory_uri() . '/scripts/jquery.dcmegamenu.1.3.3.min.js');
		wp_register_script( 'jquery-hoverintent', get_template_directory_uri(). '/scripts/jquery.hoverIntent.minified.js');					
		wp_enqueue_script('jquery-megamenu');
		wp_enqueue_script('jquery-hoverintent');

		
		wp_register_style( 'jquery-megamenu-black', get_template_directory_uri() . '/styles/skins/black.css', true);
		wp_register_style( 'jquery-style', 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.1/themes/smoothness/jquery-ui.css', true);
		wp_enqueue_style( 'jquery-style' );
		wp_enqueue_style( 'jquery-megamenu-black' );		
    }
}
add_action('init', 'my_add_frontend_scripts');

/** BuddyPress Parameters **/
