...
<?php
function edirap_jqueryUI_script() {
    wp_deregister_script( 'jquery UI' );
    wp_register_script( 'jquery UI', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.18/jquery-ui.min.js');
    wp_enqueue_script( 'jquery UI' );
}    
if(!is_admin()) 
	add_action('wp_enqueue_scripts', 'edirap_jqueryUI_script');
?>

<?php
function edirap_jqueryUI_stylesheets_method(){ 
	wp_register_style('jqueryUIStyleSheets', 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/smoothness/jquery-ui.css'); 
	wp_enqueue_style( 'jqueryUIStyleSheets'); 
} 
if(!is_admin())
	add_action('wp_print_styles', 'edirap_jqueryUI_stylesheets_method');
